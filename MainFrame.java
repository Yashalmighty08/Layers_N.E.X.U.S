...
public class MainFrame extends JFrame {
    ...
    private JTabbedPane createTabbedPane() {
        ...
        if (currentUser.getRole().equals("Manager")) {
            ...
            JPanel financePanel = createPanel("Finance & Payroll");
            JPanel reportingPanel = new ReportingPanel();
            JPanel recipePanel = createPanel("Recipe");
            JPanel inventoryPanel = createPanel("Inventory");
    ...
    private JPanel createHomePanel() {
        ...
        String roleGreeting = currentUser.getRole().equals("Manager") ? "Manager Dashboard - Full System Access"
